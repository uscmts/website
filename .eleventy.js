...
module.exports = function (config) {
  ...
  // copy directly from _img folder to _site/img
  config.addPassthroughCopy({'./_img': 'assets/img'});

  // copy directly from _docs folder to _site/docs
  config.addPassthroughCopy({'./_docs': 'assets/docs'});
